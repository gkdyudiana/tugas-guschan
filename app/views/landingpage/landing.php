...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="btn btn-block btn-outline-primary" href="<?= BASEURL; ?>/auth/login">MASUK</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="jumbotron bg-transparent" data-aos="fade-up" data-aos-duration="2000">
        <a class="navbar-brand text-dark d-flex justify-content-center" href="#"><i class="fas fa-3x fa-book-reader"></i>&nbsp;</a>
        <a class="display-4 text-center text-dark d-flex justify-content-center mt-2">Hai! Siswa Kesayangan Guru</a>
    </div>
